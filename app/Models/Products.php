...
class Products extends Model
{
    ...
    protected $fillable = ['product_id', 'product_name', 'stocks', 'product_image', 'product_type', 'created_by_user_id', 'created_by_user_name', 'updated_by_user_id', 'updated_by_user_name'];
