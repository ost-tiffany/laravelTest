...
class Transactions extends Model
{
    ...
    public function getDetailTransactionList($transaction_id) {
        return detailtransaction::join('products', 'detailtransaction.product_id', '=', 'products.product_id')->where('detailtransaction.transaction_id', $transaction_id)->where('detailtransaction.delete_flag', 0)->get()->toArray();
    }
